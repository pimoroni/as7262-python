...
try:
    while True:
        ...
        bargraph =f"""       Spectrometer Bar Graph
 ---------------------------------
|Red:    {ANSI_COLOR_RED}{red}\x1b[0m|
|Orange: {ANSI_COLOR_YELLOW}{orange}\x1b[0m|
|Yellow: {ANSI_COLOR_YELLOW}{yellow}\x1b[0m|
|Green:  {ANSI_COLOR_GREEN}{green}\x1b[0m|
|Blue:   {ANSI_COLOR_BLUE}{blue}\x1b[0m|
|Violet: {ANSI_COLOR_MAGENTA}{violet}\x1b[0m|
 ---------------------------------
